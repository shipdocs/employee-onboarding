...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    // Try to get deletion requests, fallback to empty array if table doesn't exist
    ...
    try {
      ...
      if (deletionError && deletionError.code !== '42P01') { // 42P01 = table doesn't exist
      ...
      console.log('Data deletions table not available, using empty array');
      deletionRequests = [];
    }
