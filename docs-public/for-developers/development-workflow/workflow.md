...
| **Testing** | `testing` | `your-project.vercel.app` | Testing DB | Team review |
| **Preview** | `preview` | `your-project.vercel.app` | Preview DB | Final approval |
| **Production** | `main` | `your-domain.com` | Production DB | Live system |
...
|-------------|------------|---------------|-------------|---------|
| **Testing** | `YOUR_DEV_PROJECT_ID` | Auto-sync from Production | Controlled seeds | Development testing |
| **Preview** | `YOUR_TEST_PROJECT_ID` | Auto-sync from Production | Controlled seeds | Pre-production validation |
| **Production** | `YOUR_PROJECT_ID` | Manual migrations | Real user data | Live system |
...
- Production admin account: `user@example.com`
