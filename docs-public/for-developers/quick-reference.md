...
| **Preview** | https://your-project.vercel.app | Final approval |
| **Production** | https://your-domain.com | Live system |
...
### **Test Users**
- **Manager**: `user@example.com` (magic link)
- **Crew**: `user@example.com` (magic link)
- **Demo**: `user@example.com` (magic link)
