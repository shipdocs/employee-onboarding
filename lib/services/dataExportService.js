    ...
    try {
      ...
      const templateData = {
        ...
        downloadUrl: exportJob.export_type === 'admin_bulk'
          ? `${process.env.FRONTEND_URL || 'https://maritime-onboarding.example.com'}/admin/downloads/${exportJob.id}`
          : `${process.env.FRONTEND_URL || 'https://maritime-onboarding.example.com'}/profile/downloads/${exportJob.id}`,
...
<body>
    ...
    <div class="content">
        ...
        <div style="text-align: center;">
            <a href="${isAdmin ?
              `${process.env.FRONTEND_URL || 'https://maritime-onboarding.example.com'}/admin/bulk-export` :
              `${process.env.FRONTEND_URL || 'https://maritime-onboarding.example.com'}/profile/export-data`
...
<body>
  ...
  async getUsersByCriteria(criteria) {
    let query = db.from('users').select('id, email, role, first_name, last_name');
