...
class EmailTemplateGenerator {
  ...
  getDefaultFooter(lang) {
    const commonTrans = getCommonTranslations(lang);
    return `
      <p style="margin: 5px 0;">© 2024 Maritime Maritime Services. ${getTranslation(lang, 'managerMagicLink.footer.line2', {})}</p>
    `;
  }
  ...
  async generateQuizRejectionTemplate(user, phase, quizResult, comments, lang = 'en') {
    ...
    const content = `
      ...
      <p style="margin-top: 5px;"><strong style="color: #006A82;">Maritime Maritime Services Training Team</strong></p>
    `;
