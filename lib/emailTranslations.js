...
const emailTranslations = {
  en: {
    ...
    managerMagicLink: {
      ...
      intro: 'You have been granted access to the Maritime Onboarding Platform Manager Portal. Use the link below to access your management dashboard.',
      ...
      signature: 'Maritime Onboarding Platform Management Team',
      footer: {
        line1: 'This email was sent from the Maritime Onboarding Platform Manager Portal',
        line2: '© 2024 Maritime Onboarding Platform. All rights reserved.'
      }
    },
    ...
    crewMagicLink: {
      ...
      intro: 'Welcome to Maritime Onboarding Platform! We\'re excited to have you join our crew. Your comprehensive onboarding training program is now ready, and you can begin immediately using the secure link below.',
      ...
      linkExpired: 'Link expired or need a new one?',
      requestNewLink: 'Request New Magic Link',
      welcomeMessage: 'We look forward to welcoming you aboard and wish you success in your maritime career with Maritime Onboarding Platform!',
      closing: 'Fair winds and following seas!',
      signature: 'Maritime Onboarding Platform Training Team',
      footer: {
        line1: 'This email was sent from the Maritime Onboarding Platform Crew Training System',
        line2: '© 2024 Maritime Onboarding Platform. All rights reserved.'
      }
    },
    ...
    safetyManagement: {
      subject: 'Welcome to Maritime Onboarding Platform - Pre-boarding Information',
      header: 'Welcome to Maritime Onboarding Platform',
      greeting: 'Dear {{firstName}} {{lastName}},',
      intro: 'Welcome to the Maritime Onboarding Platform family! We are excited to have you join our crew and look forward to working with you aboard our vessels.',
      assignmentTitle: 'Your Assignment Details',
      vessel: 'Vessel:',
      ...
      signature: 'Maritime Onboarding Platform Training Team',
      footer: {
        line1: 'This email was sent from the Maritime Onboarding Platform Crew Onboarding System',
        line2: '© 2024 Maritime Onboarding Platform. All rights reserved.'
      }
    },
    ...
    phaseCompletion: {
      ...
      signature: 'Maritime Onboarding Platform Training Team',
      footer: {
        line1: 'This email was sent from the Maritime Onboarding Platform Training System',
        line2: '© 2024 Maritime Onboarding Platform. All rights reserved.'
      }
    },
    ...
    progressReminder: {
      ...
      signature: 'Maritime Onboarding Platform',
      footer: {
        line1: 'This email was sent from the Maritime Onboarding Platform Training System',
        line2: '© 2024 Maritime Onboarding Platform. All rights reserved.'
      }
    ...
    managerWelcome: {
      ...
      greeting: 'Dear {{firstName}} {{lastName}},',
      intro: 'Welcome to Maritime Onboarding Platform! Your manager account has been successfully created and you now have access to our crew onboarding management system.',
      ...
      signature: 'Maritime Onboarding Platform Administration',
      footer: {
        line1: 'This email was sent from the Maritime Onboarding Platform Crew Onboarding System',
        line2: '© 2024 Maritime Onboarding Platform. All rights reserved.'
      }
    ...
    // Welcome Email
    welcome: {
      subject: 'Welcome to Maritime Onboarding Platform - Onboarding Training',
      header: '🚢 Welcome Aboard!',
      welcomeBanner: 'Welcome to Maritime Onboarding Platform',
      welcomeSubtext: 'Your maritime career journey begins here',
      greeting: 'Dear {{firstName}},',
      intro: 'Welcome to the Maritime Onboarding Platform family! We are excited to have you join our team and begin your maritime training journey.',
      assignmentTitle: 'Your Assignment Details',
      position: 'Position:',
      vessel: 'Vessel:',
      boardingDate: 'Expected Boarding:',
      ...
      signature: 'Maritime Onboarding Platform HR Team',
      footer: {
        line1: 'This email was sent from the Maritime Onboarding Platform Training System',
        line2: '© 2024 Maritime Onboarding Platform. All rights reserved.'
      }
    ...
    safetyManagement: {
      ...
      closing: 'Thank you for your commitment to safety!',
      signature: 'Maritime Onboarding Platform Safety Team',
      footer: {
        line1: 'This email was sent from the Maritime Onboarding Platform Training System',
        line2: '© 2024 Maritime Onboarding Platform. All rights reserved.'
      }
  ...
  nl: {
    ...
    managerMagicLink: {
      ...
      intro: 'U heeft toegang gekregen tot het Maritime Onboarding Platform Manager Portal. Klik op de beveiligde link hieronder om toegang te krijgen tot uw beheerdersdashboard.',
      ...
      signature: 'Maritime Onboarding Platform Management Team',
      footer: {
        line1: 'Deze e-mail is verzonden vanuit het Maritime Onboarding Platform Manager Portal',
        line2: '© 2024 Maritime Onboarding Platform. Alle rechten voorbehouden.'
      }
    },
    ...
    crewMagicLink: {
      ...
      intro: 'Welkom bij Maritime Onboarding Platform! We zijn verheugd dat u zich bij onze bemanning voegt. Uw uitgebreide onboarding trainingsprogramma is nu klaar en u kunt direct beginnen met de beveiligde link hieronder.',
      ...
      linkExpired: 'Link verlopen of heeft u een nieuwe nodig?',
      requestNewLink: 'Vraag Nieuwe Magic Link Aan',
      welcomeMessage: 'We kijken ernaar uit u aan boord te verwelkomen en wensen u succes in uw maritieme carrière bij Maritime Onboarding Platform!',
      closing: 'Gunstige wind en volgende zeeën!',
      signature: 'Maritime Onboarding Platform Training Team',
      footer: {
        line1: 'Deze e-mail is verzonden vanuit het Maritime Onboarding Platform Crew Training Systeem',
        line2: '© 2024 Maritime Onboarding Platform. Alle rechten voorbehouden.'
      }
    },
    ...
    safetyManagement: {
      ...
      closing: 'Veilige vaart!',
      signature: 'Maritime Onboarding Platform Veiligheidsteam',
      footer: {
        line1: 'Deze e-mail is verzonden vanuit het Maritime Onboarding Platform Safety Management System',
        line2: '© 2024 Maritime Onboarding Platform. Alle rechten voorbehouden.'
      }
    },
    ...
    phaseCompletion: {
      ...
      signature: 'Maritime Onboarding Platform Training Team',
      footer: {
        line1: 'Dit bericht is verzonden vanuit het Maritime Onboarding Platform Training Systeem',
        line2: '© 2024 Maritime Onboarding Platform. Alle rechten voorbehouden.'
      }
    },
    ...
    progressReminder: {
      ...
      signature: 'Maritime Onboarding Platform',
      footer: {
        line1: 'Deze e-mail is verzonden vanuit het Maritime Onboarding Platform Training Systeem',
        line2: '© 2024 Maritime Onboarding Platform. Alle rechten voorbehouden.'
      }
    },
    ...
    managerWelcome: {
      ...
      greeting: 'Beste {{firstName}} {{lastName}},',
      intro: 'Welkom bij Maritime Onboarding Platform! Uw manager account is succesvol aangemaakt en u heeft nu toegang tot ons bemanning onboarding beheersysteem.',
      ...
      signature: 'Maritime Onboarding Platform Administratie',
      footer: {
        line1: 'Deze e-mail is verzonden vanuit het Maritime Onboarding Platform Crew Onboarding Systeem',
        line2: '© 2024 Maritime Onboarding Platform. Alle rechten voorbehouden.'
      }
    },
    ...
    // Welcome Email - Dutch
    welcome: {
      subject: 'Welkom bij Maritime Onboarding Platform - Inwerk Training',
      header: '🚢 Welkom aan Boord!',
      welcomeBanner: 'Welkom bij Maritime Onboarding Platform',
      welcomeSubtext: 'Uw maritieme carrière begint hier',
      greeting: 'Beste {{firstName}},',
      intro: 'Welkom bij de Maritime Onboarding Platform familie! We zijn verheugd dat u zich bij ons team voegt en uw maritieme trainingsreis begint.',
      assignmentTitle: 'Uw Toewijzingsgegevens',
      position: 'Positie:',
      vessel: 'Schip:',
      boardingDate: 'Verwachte Inscheping:',
