...
- **Preview**: https://new-onboarding-2025-git-preview-shipdocs-projects.vercel.app  
...
- **Admin**: `adminmartexx@shipdocs.app` / `Yumminova21!@#`
...
```bash
# Check user exists
SELECT * FROM users WHERE email = 'adminmartexx@shipdocs.app';
