...
NODE_ENV=testing
VITE_API_URL=https://new-onboarding-2025-git-testing-shipdocs-projects.vercel.app/api
SUPABASE_URL=https://test-xxx.supabase.co
ENABLE_DEBUG_LOGGING=true
```

**Access**:
- URL: `https://new-onboarding-2025-git-testing-shipdocs-projects.vercel.app`
...
# Vercel environment variables
NODE_ENV=preview
VITE_API_URL=https://new-onboarding-2025-git-preview-shipdocs-projects.vercel.app/api
SUPABASE_URL=https://preview-xxx.supabase.co
ENABLE_ANALYTICS=true
```

**Access**:
- URL: `https://new-onboarding-2025-git-preview-shipdocs-projects.vercel.app`
...
**Access**:
- URL: `https://onboarding.burando.online`
...
# Email Service
MAILERSEND_API_KEY=
EMAIL_FROM=noreply@onboarding.burando.online
