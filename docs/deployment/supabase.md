...
[
  {
    "origin": ["https://onboarding.burando.online"],
    "allowed_headers": ["*"],
    "exposed_headers": ["*"],
    "max_age": 86400,
...
#### General Settings
- **Site URL**: `https://onboarding.burando.online`
- **Redirect URLs**: 
  - `https://onboarding.burando.online/magic-login`
  - `https://onboarding.burando.online/auth/callback`
