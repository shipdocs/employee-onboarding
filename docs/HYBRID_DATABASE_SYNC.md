...
│         awylsjqmqhsegvvrkiim | atonfoxqfdfmraucwygt            │
│                                                                 │
...
|-------|------|----------|---------|
| `adminmartexx@shipdocs.app` | Admin | `Yumminova21!@#` | System administration |
| `manager@shipdocs.app` | Manager | Magic link | Training management |
| `crew.test@shipdocs.app` | Crew | Magic link | Training completion |
| `demo.crew@shipdocs.app` | Crew | Magic link | Demo scenarios |
