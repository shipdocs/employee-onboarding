...
|-------------|-----|---------|
| **Testing** | `new-onboarding-2025-git-testing-shipdocs-projects.vercel.app` | Team testing |
| **Preview** | `new-onboarding-2025-git-preview-shipdocs-projects.vercel.app` | Stakeholder review |
| **Production** | `onboarding.burando.online` | Live system |
...
curl -H "Authorization: Bearer $TOKEN" \
  https://onboarding.burando.online/api/health/detailed
```
